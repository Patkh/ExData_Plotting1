## Plot Global Active Power (kilowatts) for the dates 2007-02-01 and 2007-02-02
...
## The line type is "l" for line and there is no x-label
with(elesub,plot(Global_active_power~Date,type="l",ylab="Global active power(kilowatts)",xlab=""))
